...
The Elyna API uses API keys to authenticate requests. You need to include your API key in the header of each request you make to the API.

## Obtaining an API Key

To obtain an API key:

1. Log in to your Elyna account at [https://app.elyna.mx](https://app.elyna.mx)
...
```bash
curl -X GET "https://api.elyna.ai/api/user/campaigns" \
