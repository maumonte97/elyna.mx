...
<AccordionGroup>
  ...
  <Accordion title="Webhook URL" icon="link">
    ...
    **Example:** `https://automate.elyna.ai/api/v1/webhooks/your-webhook-id`
...
```json
{
  ...
  "transcript": [
    {
      "text": "Hello! This is Sarah from Elyna.",
      "type": "transcript",
      "sender": "bot",
  ...
  "formatted_transcript": "AI: Hello! This is Sarah from Elyna.\\nCustomer: Hi, I'm doing well, thanks.",
  "recording_url": "https://app.elyna.ai/storage/recordings/call-12345.mp4",
