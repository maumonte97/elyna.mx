    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-28">
      ...
      <motion.div variants={container} initial="hidden" animate="visible" className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        ...
        <motion.h1 variants={fadeUp} className="text-4xl md:text-6xl lg:text-7xl font-bold leading-tight mb-6">
          {t.hero.title1}
          <span className="bg-gradient-to-r from-[var(--primary)] via-[var(--primary-light)] to-[var(--accent)] bg-clip-text text-transparent">{t.hero.titleHighlight}</span>
        </motion.h1>
        ...
        <motion.div variants={fadeUp} className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <a href="#producto" className="flex items-center gap-2 border border-white/10 text-white px-8 py-3.5 rounded-[22px] hover:bg-white/5 transition-all">{t.hero.cta2}</a>
        </motion.div>
          ...
          <div className="relative bg-[var(--dark-card)] border border-[var(--dark-border)] rounded-[22px] p-6 md:p-8">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div className="flex-1 bg-white/5 rounded-lg h-7 flex items-center px-3">
                <span className="text-xs text-gray-500">{t.hero.mockUrl}</span>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-white/5 rounded-2xl p-5">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <p className="text-sm font-medium">{t.hero.activeCall}</p>
              ...
              <div className="bg-white/5 rounded-2xl p-5">
                <p className="text-xs text-gray-500 mb-3 uppercase tracking-wider">{t.hero.liveTranscript}</p>
                <div className="space-y-3 text-sm">
                  <div className="flex gap-2"><span className="text-[var(--primary)] font-medium shrink-0">{t.hero.aiLabel}</span><span className="text-gray-300">{t.hero.aiMsg1}</span></div>
                  <div className="flex gap-2"><span className="text-[var(--accent)] font-medium shrink-0">{t.hero.clientLabel}</span><span className="text-gray-300">{t.hero.clientMsg1}</span></div>
                  <div className="flex gap-2"><span className="text-[var(--primary)] font-medium shrink-0">{t.hero.aiLabel}</span><span className="text-gray-300">{t.hero.aiMsg2}</span></div>
                </div>
              </div>
            </div>
          </div>
