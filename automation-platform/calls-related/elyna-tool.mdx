...
title: "Elyna tool"
icon: "phone"
description: "Learn how to use Elyna triggers and actions in your AI calling flows"
---

# Elyna tool

The Elyna tool is the core component that connects your AI calling system with automation flows. It enables real-time data exchange between your AI assistants and business systems, allowing for personalized conversations and automated follow-ups.

<Note>
  You can find the Elyna tool prominently displayed at the top of the
